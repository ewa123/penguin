...
namespace WindowsFormsApplication4
{
    public partial class Form2 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            label1.Text = (((Double.Parse(textBox1.Text) * Double.Parse(textBox1.Text)) / (19.6)) + (Double.Parse(textBox3.Text) / (Double.Parse(textBox4.Text)) + (Double.Parse(textBox5.Text)) - (((Double.Parse(textBox6.Text) * Double.Parse(textBox6.Text)) / (19.6)) + (Double.Parse(textBox8.Text)) / (Double.Parse(textBox4.Text)) + (Double.Parse(textBox10.Text))))).ToString();
